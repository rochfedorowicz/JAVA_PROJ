...
/**
 * This class is resposible for handling data
...
public class Model {
    ...
    * @param person New person to be added
     * @throws com.polsl.model.KeyViolationException
     * @throws com.polsl.model.NameViolationException
    */
    ...
    * @throws com.polsl.model.InstanceNotFoundException
    */
    ...
    * @param ID ID of task that should be retruned
    ...
    * @param signum Signum of person that should be retruned
